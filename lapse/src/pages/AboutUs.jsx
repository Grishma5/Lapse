    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-200' : 'bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 text-gray-800'}`}>
      ...
      <section className="py-40 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className={`text-5xl md:text-6xl font-bold mb-6 ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
            About{' '}
          ...
          <p className={`text-xl max-w-3xl mx-auto mb-8 leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`}>
            Lapse is a simple task management app created to help you stay organized and manage tasks effortlessly.
          </p>

          <div className={`inline-flex items-center px-6 py-3 ${isDarkMode ? 'bg-gray-700/60' : 'bg-white/70'} backdrop-blur-md rounded-full shadow-lg`}>
            <CheckCircle className="w-5 h-5 mr-3 text-pink-500" />
            <span className={`${isDarkMode ? 'text-gray-300' : 'text-gray-700'} font-semibold`}>Built for simplicity and efficiency</span>
          </div>
        </div>
      </section>

      {/* What is Lapse Section */}
      <section className={`${isDarkMode ? 'bg-gray-800/60' : 'bg-white/60'} backdrop-blur-sm py-16`}>
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className={`text-3xl font-bold mb-6 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>What is Lapse?</h2>
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className={`w-80 h-80 rounded-3xl flex items-center justify-center shadow-xl ${isDarkMode ? 'bg-gradient-to-br from-gray-700 to-gray-600' : 'bg-gradient-to-br from-pink-200 to-purple-200'}`}>
                  {/* SVG Illustration */}
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center order-2 md:order-1">
              <div className="relative">
                <div className={`w-80 h-80 rounded-3xl flex items-center justify-center shadow-xl ${isDarkMode ? 'bg-gradient-to-br from-gray-700 to-gray-600' : 'bg-gradient-to-br from-purple-200 to-indigo-200'}`}>
                  {/* SVG Illustration */}
                  <svg className="w-48 h-48" viewBox="0 0 200 200" fill="none">
            ...
            <div className="order-1 md:order-2">
              <h2 className={`text-3xl font-bold mb-6 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>How was it made?</h2>
              <p className={`text-lg leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`}>
