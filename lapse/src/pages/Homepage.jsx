...
const LapseHomepage = () => {
  ...
  const processSteps = [
    {
      ...
      description: "Sign up with full name, email and password",
    },
    {
      number: "2",
      title: "Add Your Tasks",
      description: "Create tasks with descriptions, priorities, and deadlines",
    },
    {
      number: "3",
      title: "Organize & Track",
      description: "Use Kanban boards and calendar views to manage your workflow",
    },
    {
      number: "4",
      title: "Achieve Goals",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-10">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-gray-800">Organize. Prioritize.</span>
            ...
            <div className="relative">
              <div className="relative w-full h-96 bg-gradient-to-br from-pink-100 to-purple-100 rounded-3xl overflow-hidden shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-32 h-32 bg-gradient-to-br from-pink-200 to-purple-300 rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg">
                      <CheckCircle className="w-16 h-16 text-white" />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">Stay Organized</h3>
                    <p className="text-gray-600">Keep track of everything that matters</p>
                  </div>
                </div>
                <div className="absolute top-6 right-6 w-12 h-12 bg-pink-300 rounded-full opacity-60 animate-bounce"></div>
                <div className="absolute bottom-8 left-8 w-8 h-8 bg-purple-300 rounded-full opacity-60 animate-pulse"></div>
                <div className="absolute top-1/2 left-6 w-6 h-6 bg-indigo-300 rounded-full opacity-60 animate-ping"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
              >
                <div className={`w-16 h-16 ${feature.color} rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg`}>
                  {feature.icon}
                </div>
      ...
      <section id="how-it-works" className="py-20 bg-gradient-to-br from-pink-100/50 to-purple-100/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
                <div className="w-24 h-24 bg-gradient-to-br from-pink-400 to-purple-200 rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg">
                  <Target className="w-12 h-12 text-white" />
                </div>
                <h3 className="text-2xl font-bold text-gray-800 text-center mb-4">Simple Process</h3>
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-purple-300 rounded-full opacity-60 animate-pulse"></div>
            </div>
            <div>
              ...
              <div className="space-y-6">
                {processSteps.map((step, index) => (
                  <div key={index} className="flex items-start">
                    <div className="w-10 h-10 bg-gradient-to-br from-pink-400 to-purple-300 rounded-full flex items-center justify-center text-white font-bold mr-4 mt-1 shadow-lg">
                      {step.number}
                    </div>
                    <div>
      ...
      <section id="about" className="py-20 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                Why <span className="bg-gradient-to-r from-pink-400 to-purple-200 bg-clip-text text-transparent">Lapse</span>?
              </h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-pink-400 to-purple-200 rounded-full flex items-center justify-center mr-3">
                    <CheckCircle className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-700">Secure password hashing and session management</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-pink-400 to-purple-300 rounded-full flex items-center justify-center mr-3">
                    <CheckCircle className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-700">Real-time task activity logging</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-gradient-to-br from-pink-400 to-purple-300 rounded-full flex items-center justify-center mr-3">
                    <CheckCircle className="w-4 h-4 text-white" />
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-3xl p-8 h-96 flex items-center justify-center shadow-2xl">
                <div className="text-center">
                  <div className="w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-300 rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg">
              ...
              <div className="absolute top-4 left-4 w-12 h-12 bg-pink-300 rounded-full opacity-60 animate-pulse"></div>
              <div className="absolute bottom-8 right-8 w-8 h-8 bg-purple-300 rounded-full opacity-60 animate-bounce"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contact Us Section */}
      <section id="contact" className="py-20 bg-gradient-to-b   from-pink-100/50 to-purple-100/50 p-6">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#09000c]">
              Contact <span className="bg-gradient-to-r from-[#e17eb5] to-[#7d85f3] bg-clip-text text-transparent">Us</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              className="bg-[#FFF0F1]/80 p-6 rounded-2xl shadow-lg border border-[#ECD2E0]/50"
            >
              <h3 className="text-xl font-semibold text-[#8686b9] mb-4">Contact Details</h3>
              <div className="space-y-4">
                <p className="text-[#A7ABDE]">
            ...
            <motion.div
              ...
              className="bg-[#FFF0F1]/80 p-6 rounded-2xl shadow-lg border border-[#ECD2E0]/50"
            >
              <h3 className="text-xl font-semibold text-[#8686b9] mb-4">Our Location</h3>
